...
**What is ORCA?** It's a methodology within the Object Oriented UX philosophy evangelized by Sophia Prater, and provides a design framework of thinking in objects-first rather than actions-first. [Read more about it at ooux.com](https://www.ooux.com/what-is-ooux)

![Audit of Wedding Spot homepage with colored dots that correspond to different phases of the ORCA methodology.](/images/weddingspot/WS_ContentAudit_CloseUp_Hompage_OOUX.jpg "Audit of Wedding Spot homepage with colored dots that correspond to different phases of the ORCA methodology.")

### Mapping content types
Using the Objects (blue) - Relationships (blue) - CTAs (green) - Attributes (pink/yellow) framework, I first analyzed Wedding Spot's public-facing and back-end as both a couple/planner user and venue user. This allowed me to:<ul><li>Identify content patterns across the product</li><li>Group like content types in a coherent way that made sense for the user</li><li>Better map a user's workflow and relationships from screen to screen</li></ul>
![Chart mapping different aspects of ORCA.](/images/weddingspot/WS_ContentAudit_OOUXmapping.jpg "Chart mapping different aspects of ORCA. Groupings include objects, calls to action, metadata, and core content.")
...
![Eagle-eye view of one piece of the larger audit. This shows workflows from one screen to the next, and now they connect throughout the product.](/images/weddingspot/WS_ContentAudit_EagleEyeExcerpt.jpg "Eagle-eye view of one piece of the larger audit. This shows workflows from one screen to the next, and now they connect throughout the product.")

![Analysis of dropdowns available in the back-end of Wedding Spot](/images/weddingspot/WS_ContentAudit_EagleEyeExcerpt_Forms.jpg "Analysis of dropdowns available in the back-end of Wedding Spot")

![Flow and site map of Wedding Spot to quickly understand how a person moves through the product.](/images/weddingspot/WS_ContentAudit_CTAalignmentMap_SRP.jpg "Flow and site map of Wedding Spot to quickly understand how a person moves through the product.")
...
![Competitor audit in Figjam](/images/weddingspot/WS_ContentAudit_CompetitorAudit.jpg "Competitor audit in Figjam")
